...
int string_to_int(char str[])
{
	...
	{
		cout << "ƒанна€ строка не €вл€етс€ целым дес€тичным числом" << endl;
		return 0;
	}
	else
	{
...
int bin_to_int(char str[])
{
	...
	{
		cout << "ƒанна€ строка не €вл€етс€ двоичным числом" << endl;
		return 0;
	}
	else
	{
...
int hex_to_int(char str[])
{
	...
	{
		cout << "ƒанна€ строка не €вл€етс€ шестнадцатеричным числом" << endl;
		return 0;
	}
	else
	{
...
/*
	—трока в €зыке — предстовл€ет собой массив элементов типа char, последним элементов этого массива об€зательно должен быть ASCi символ с кодом 0 - ('\0')
	именно по этому строки в €зыке — называют NULL Terminated Lines(строки заканчивающиес€ на ноль) ноль на конце €вл€етьс€ признаком конца строки и даже если строка содержит символы после нул€ эти символы будут проигнорированы
*/